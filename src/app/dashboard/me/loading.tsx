            ...
            <main className="container mx-auto px-64">
                <div className="flex h-screen">
                    <div className="flex items-center">
                        ...
                        <div>
                            <div className="flex h-4 w-96 rounded shadow-lg bg-[#1f1f1f] animate-pulse mb-1"></div>
                            <div className="flex h-4 w-44 rounded shadow-lg bg-[#1f1f1f] animate-pulse"></div>
                        </div>
                    </div>
